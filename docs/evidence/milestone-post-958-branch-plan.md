...
| 7 | **Wiki audit** | JOE-917; P1 remediations + P2 backlog | **P0/P1 done**; P2-2 scope-token, P2-3 readiness CI policy, P2-5 multi-replica OAuth **done**; P2-1/P2-4 progressive |
...
5. Progressive: JOE-941 Durable V2 (pin-gated), wiki P2-1/P2-4, channel body migrate.  
