...
| 7 | **Wiki audit** | JOE-917; P1 remediations + P2 backlog | **P0/P1 done**; P2-2–P2-5 **done**; P2-1 module splits still progressive |
...
5. Progressive: JOE-941 Durable V2 (pin-gated), wiki P2-1 module splits, channel body migrate.  
