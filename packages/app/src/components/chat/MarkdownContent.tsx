...
export function MarkdownContent({
  ...
  return (
    <div
      ...
      className={`chat-markdown-content prose prose-p:my-1 prose-p:last:mb-0 prose-headings:my-2 prose-headings:last:mb-0 prose-ul:my-1 prose-ol:my-1 prose-li:my-0 text-text ${streaming ? 'chat-markdown-content--streaming' : ''} ${className}`.trim()}
    />
  )
}
