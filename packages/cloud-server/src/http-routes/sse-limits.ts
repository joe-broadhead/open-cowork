...
// route handlers back in. Hoisting the pure numeric limits into this dependency-free
// leaf lets both http-server.ts and the http-routes/* handlers import them without the
// cycle (ARCH SSE constant cycle, P3).
