...
export const GATEWAY_PROVIDER_READINESS_MATRIX: GatewayProviderReadinessEntry[] = [
  ...
  },
  {
    ...
    fileSupport: 'Inbound attachments are accepted up to the Gateway request-body cap; outbound artifacts should render as links.',
  ...
  },
  {
    ...
    ingressModes: ['webhook'],
    approvalMode: 'inline-or-token',
    fileSupport: 'Inbound files may be carried inline up to the Gateway request-body cap; outbound file downloads should be represented by links.',
  ...
  },
  {
    ...
    approvalMode: 'inline-or-token',
    fileSupport: 'Bridge advertises upload and download support within the Gateway request-body cap.',
  ...
  },
  {
    ...
    ingressModes: ['signed bridge webhook'],
    approvalMode: 'inline-or-token',
    fileSupport: 'Bridge advertises media upload and download support within the Gateway request-body cap.',
  ...
  },
  {
    ...
    ingressModes: ['signed bridge webhook'],
    approvalMode: 'token-fallback',
    fileSupport: 'Bridge advertises media upload and download support within the Gateway request-body cap; approvals use command-token fallback.',
  ...
  },
  {
    ...
    approvalMode: 'inline-or-token',
    fileSupport: 'In-memory fake file behavior for deterministic tests only, constrained to the Gateway request-body cap.',
