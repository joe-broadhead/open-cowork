export function cloudWebsiteStudioPrimitiveStyles() {
  return String.raw`    .studio-shell--collapsed { grid-template-columns: var(--studio-shell-rail-w) minmax(0, 1fr); }
    ...
    .studio-trait-slider__ends { display: flex; align-items: center; }
    ...
    .studio-presence-dot { position: absolute; inset-inline-end: calc(-1 * var(--space-1)); inset-block-end: calc(-1 * var(--space-1)); width: var(--space-3); height: var(--space-3); border: 2px solid var(--color-elevated); border-radius: var(--radius-full); background: var(--color-text-muted); }
    .studio-presence-dot--working { background: var(--color-accent); }
    .studio-presence-dot--available { background: var(--color-green); }
    .studio-presence-dot--offline { background: var(--color-text-muted); }
    ...
    .studio-permission-row p { margin: 0; color: var(--color-text-muted); font-size: var(--text-xs); line-height: var(--lh-xs); }
    .studio-u-card-title { display: block; margin: 0; color: var(--color-text); font-size: var(--text-sm); font-weight: 700; line-height: var(--lh-sm); }
    .studio-u-card-text { margin: 0; color: var(--color-text-muted); font-size: var(--text-xs); line-height: var(--lh-xs); }
    .studio-conversation-lane-card__task { overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
    .studio-conversation-lane-card__meta { display: inline-flex; flex: none; align-items: center; gap: var(--space-2); color: var(--color-text-muted); font-size: var(--text-xs); }
    ...
    .studio-working-style-bars { display: flex; flex-direction: column; }
    ...
    .studio-activity-row time { color: var(--color-text-muted); font-size: var(--text-2xs); }
    ...
    .studio-status-waiting { color: var(--color-text-muted); }
    .studio-handoff-chip { align-self: flex-start; gap: var(--space-2); border: var(--border-width-1) solid color-mix(in srgb, var(--studio-lane-tone) 28%, transparent); border-radius: var(--radius-full); background: color-mix(in srgb, var(--studio-lane-tone) 10%, transparent); color: var(--color-text-secondary); padding: var(--space-1) var(--space-3); font-size: var(--text-xs); }    .studio-unassigned { gap: var(--space-1); color: var(--color-text-muted); }
    ...
    .studio-run-timeline__step { position: relative; display: flex; flex: 1; flex-direction: column; align-items: center; gap: var(--space-2); color: var(--color-text-muted); font-size: var(--text-2xs); font-weight: 700; }
    ...
    .studio-run-timeline__meta { margin-top: var(--space-3); color: var(--color-text-muted); font-size: var(--text-xs); }
    ...
    .studio-permission-rule span { color: var(--color-text-muted); font-size: var(--text-2xs); font-weight: 700; text-transform: uppercase; }
    ...
    .studio-deliverable-card__captured { gap: var(--space-2); border-radius: var(--radius-md); background: color-mix(in srgb, var(--color-green) 12%, transparent); color: var(--color-green); padding: var(--space-2) var(--space-3); font-size: var(--text-xs); font-weight: 700; }    .studio-u-progress-track,
    ...
    .studio-working-style-bars__row i { display: block; width: var(--studio-progress); height: 100%; border-radius: inherit; background: var(--accent-gradient); }    .studio-projects-surface { display: flex; min-height: 0; flex: 1; flex-direction: column; gap: var(--space-4); color: var(--color-text); }    .studio-team-count,
    .studio-team-empty { color: var(--color-text-muted); font-size: var(--text-xs); }
    .studio-team-count { display: inline-flex; min-width: var(--space-6); height: var(--space-6); align-items: center; justify-content: center; border: var(--border-width-1) solid var(--color-border-subtle); border-radius: var(--radius-full); background: var(--color-surface); }    .studio-u-row-surface,
    ...
    .studio-wizard-steps button > span { display: inline-flex; width: var(--space-5); height: var(--space-5); align-items: center; justify-content: center; border: var(--border-width-1) solid var(--color-border); border-radius: var(--radius-full); background: var(--color-elevated); color: var(--color-text-muted); font-size: var(--text-2xs); }
    ...
    .studio-wizard-step-pane p { margin: var(--space-1) 0 var(--space-4); color: var(--color-text-muted); font-size: var(--text-sm); line-height: var(--lh-sm); }
    ...
    .studio-trait-slider__ends { color: var(--color-text-muted); font-size: var(--text-xs); }
    .studio-working-style-bars { gap: var(--space-2); margin-top: var(--space-3); }
    .studio-working-style-bars__row { display: grid; grid-template-columns: minmax(70px, auto) minmax(0, 1fr); align-items: center; gap: var(--space-3); color: var(--color-text-muted); font-size: var(--text-2xs); font-weight: 750; text-transform: uppercase; }
