...
export const STUDIO_VISUAL_QA_MATRIX: StudioVisualQaEntry[] = [
  ...
  },
  {
    ...
    cloudCheck: 'Coworker cards expose Lead/Specialist filters and Brain/Temperature/Max steps config specs; Tools & Skills renders tabbed Abilities and Connections with MCP policy verdicts and shared Studio primitives.',
  ...
  },
  {
    ...
    cloudCheck: 'Playbook cards and selected details show numbered ordered steps, Runs as metadata, last-run status, run rows, pause/resume/archive actions, empty states, and blocked policy copy.',
    states: ['loading', 'empty', 'error', 'disabled', 'permission-gated', 'offline-disconnected', 'retry', 'destructive-confirmation'],
