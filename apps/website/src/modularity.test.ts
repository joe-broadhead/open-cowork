...
void test('cloud web workbench production source stays split into bounded modules', () => {
  ...
  const requiredModules = [
    ...
    'branding.ts',
    'client-contract.ts',
    'cloud-user-preferences-client.ts',
    'cloud-settings-markup.ts',
    ...
    'react-workbench-artifacts.tsx',
    'react-workbench-channels.tsx',
    'react-shell.ts',
    'react-shell-controller.tsx',
    'react-state.ts',
    'react-workbench-approvals.ts',
    ...
    'react-workbench-portals.tsx',
    'react-workbench-projects.tsx',
    'react-workbench-review.tsx',
    'react-workbench-statusbar.ts',
