...
export const CLOUD_WEB_ROUTE_API_MATRIX: CloudWebRouteApiMatrixEntry[] = [
  ...
  },
  {
    ...
    surface: 'workbench',
    requiredRole: 'public',
    endpointIds: ['launchpadFeed', 'sessionView', 'sessionEvents', 'sessionPrompt', 'sessionAbort', 'sessionPermissionRespond', 'sessionQuestionReply', 'sessionQuestionReject'],
    states: {
  ...
  },
  {
    ...
    endpointIds: [
      ...
      'knowledgePageRestore',
    ],
    states: {
      loading: 'Knowledge Spaces, pages, proposals, history, and graph hydrate from /api/knowledge after sign-in.',
    ...
    redactionContract: redactionContract('metadata-only'),
    tests: ['browser-e2e.test.ts', 'render.test.ts', 'studio-production-qa.test.ts'],
  },
  {
    routeId: 'settings',
    surface: 'workbench',
