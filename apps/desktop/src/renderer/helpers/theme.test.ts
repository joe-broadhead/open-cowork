...
describe('appearance theme defaults', () => {
  it('defaults first-run appearance to Mercury with the Azure accent', () => {
    ...
    expect(document.documentElement.style.getPropertyValue('--color-base')).toBe('#15151f')
    expect(document.documentElement.style.getPropertyValue('--color-accent')).toBe('#8da4f5')
    expect(document.documentElement.style.getPropertyValue('--accent-2')).toBe('#b08cf6')
    expect(document.documentElement.style.getPropertyValue('--accent-text')).toBe('#b08cf6')
