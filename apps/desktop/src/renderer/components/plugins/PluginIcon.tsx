...
const icons: Record<string, (size: number) => ReactElement> = {
  ...
  workflow: (s) => (
    <svg width={s * 0.55} height={s * 0.55} viewBox="0 0 24 24" fill="none">
      <rect x="4" y="4" width="16" height="16" rx="4" fill="#182235"/>
      <path d="M8 8.5h5.5a2.5 2.5 0 010 5H10.5a2 2 0 000 4H16" stroke="#7dd3fc" strokeWidth="1.8" strokeLinecap="round"/>
      <circle cx="8" cy="8.5" r="1.7" fill="#34d399"/>
      <circle cx="16" cy="17.5" r="1.7" fill="#fbbf24"/>
    </svg>
  ),
  github: (s) => (
    <svg width={s * 0.55} height={s * 0.55} viewBox="0 0 24 24" fill="none">
