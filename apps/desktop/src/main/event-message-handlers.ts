...
export const MAX_TOTAL_MESSAGE_ROLES = 10_000
...
export type DispatchRuntimeEvent = (win: BrowserWindow, event: RuntimeSessionEvent) => void
...
export function markNativeMessageOwned(
...
export function markNativeToolOwned(
  state: SessionScopedMessageState,
  sessionId: string,
  callId: string,
) {
...
function nativeToolKey(sessionId: string | null | undefined, callId: string) {
