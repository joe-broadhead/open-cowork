...
import { canPromoteNumericColorToQuantitative, getFieldValues, inferBarChartEncoding, inferSequentialXAxisEncoding, normalizeSeriesColorField } from './chart-utils.js'
...
function chartToolDescription(description: string) {
