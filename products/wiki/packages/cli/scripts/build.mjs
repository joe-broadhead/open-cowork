...
await fs.writeFile(
  ...
  [
    "# @openwiki/cli",
    "",
    "Installable OpenWiki command-line interface for local wikis, MCP, setup, diagnostics, and static export.",
    "",
    "Install this tarball from the matching GitHub release or a source checkout build:",
    "",
    "```sh",
    `npm install -g ./openwiki-cli-${rootPackage.version}.tgz`,
    "openwiki --version",
    "openwiki doctor",
