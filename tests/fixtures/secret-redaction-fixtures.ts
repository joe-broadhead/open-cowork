...
export const SECRET_REDACTION_FIXTURES: SecretRedactionFixture[] = [
  ...
  { id: 'managed-worker-credential', label: 'Open Cowork managed-worker credential', value: `ocw_mwcred_${'n'.repeat(16)}_${'o'.repeat(32)}` },
  { id: 'github-classic-token', label: 'GitHub classic token', value: token('ghp_', 'p', 36) },
